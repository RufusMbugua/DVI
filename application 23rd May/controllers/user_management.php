...
class User_Management extends MY_Controller 
{
	...
	public function login_submit() 
	{
		...
		if ($returned_user) 
		{
			...
			'user_group' => $returned_user['User_Group'], 
			'user_identifier' => $returned_user -> Group -> Identifier, 
			'user_group_name' => $returned_user -> Group -> Name, 
			'username' => $returned_user['Username'], 
			'full_name' => $returned_user['Full_Name'], 
			'district_province_id' => $returned_user['District_Province_Id']);
