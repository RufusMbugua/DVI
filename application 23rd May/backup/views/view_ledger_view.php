...
autocomplete_elements[0] = {value: "All Stores", id: "national_0"}
	...
	$(".delete").click(function(){
		url = " <?php echo 'disbursement_management/delete_disbursement/'?>" +$(this).attr("disbursement");
...
<option <?php if($this->session->userdata('order_by') == "Unix_Timestamp(str_to_date(Date_Issued,'%m/%d/%Y'))"){echo "selected";}?> value="Unix_Timestamp(str_to_date(Date_Issued,'%m/%d/%Y'))">Date Issued</option>
<option <?php if($this->session->userdata('order_by') == "Voucher_Number"){echo "selected";}?>  value="Voucher_Number">Voucher Number</option>
<option <?php if($this->session->userdata('order_by') == "Added_By"){echo "selected";}?>  value="Added_By">Added By</option>
</select>
