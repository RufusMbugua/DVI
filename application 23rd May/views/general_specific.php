<script>
	$(function() {
		...
		var url = '<?php echo base_url()."months_of_stock/get_mos_balance/0/".$province_id."/0"?>'; 
		...
		var url = '<?php echo base_url()."cold_chain/get_utilization/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_fridge_occupancy/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_freezer_occupancy/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."mos_trend/get/0/0/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."consumption_forecast/forecast/0/0/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."antigen_recipients/recipients/0/0/0/0/".$province_id."/0"?>'; 
		chart.setDataURL(url);
		...
		$(".view_larger_graph").click(function(){
			...
			if(id == "cold_chain_graph"){
				$("#larger_graph_container").dialog({title: "Regional Cold Chain Utilization"});
		...
		$("#refresh_mos_trend_graph").click(function(){
			var vaccine_string = "";
				...
				var data_url = '<?php echo base_url();?>mos_trend/download_mos_trend/'+selected_year+'/0/<?php echo $province_id."/0"?>'; 
				$("#trend_data_download").attr("href",data_url);
				$("#mos_trend_larger_graph_container").dialog('option', 'title', 'Antigen MOS Balance Trend');
				$("#mos_trend_larger_graph_container").dialog("open");
				var chart = new FusionCharts("<?php echo base_url()."Scripts/FusionCharts/Charts/MSLine.swf"?>", "ChartId", "900", "450", "0", "0");	
				var url = '<?php echo base_url();?>mos_trend/get/'+vaccine_string+'/'+selected_year+'/0/<?php echo $province_id."/0"?>'; 
				chart.setDataURL(url);
				chart.render("mos_trend_larger_graph");
		});
		$("#refresh_forecast_graph").click(function(){
				...
				var data_url = '<?php echo base_url();?>consumption_forecast/download_forecast/'+selected_vaccine+'/'+selected_year+'/0/<?php echo $province_id."/0"?>';
				$("#forecast_data_download").attr("href",data_url);
				$("#forecast_larger_graph_container").dialog('option', 'title', 'Antigen Consumption Vs. Forecast');
				$("#forecast_larger_graph_container").dialog("open"); 
				var chart = new FusionCharts("<?php echo base_url()."Scripts/FusionCharts/Charts/Column2D.swf"?>", "ChartId", "900", "450", "0", "0");   
				var url = '<?php echo base_url()?>consumption_forecast/forecast/'+selected_vaccine+'/'+selected_year+'/0/<?php echo $province_id."/0"?>'; 
				chart.setDataURL(url);
				chart.render("forecast_larger_graph");
		});
		$("#refresh_recipients_graph").click(function(){
				...
				var data_url = '<?php echo base_url();?>antigen_recipients/download_recipients/'+selected_year+'/'+selected_quarter+"/0/<?php echo $province_id."/0"?>";
				...
				var url = '<?php echo base_url();?>antigen_recipients/recipients/'+selected_vaccine+'/'+selected_year+'/'+selected_quarter+'/0/<?php echo $province_id."/0"?>';  
				chart.setDataURL(url);
				chart.render("recipients_larger_graph");
		});
...
<div class="larger_graph">
	<a class="link view_larger_graph" href="#" id="mos_graph">Enlarge</a> | <a class="link" href="<?php echo base_url().'months_of_stock/download/0/'.$province_id.'/0';?>">Download Data</a>
</div>
<div class="mos_legend">
...
<div class="larger_graph">
	<a class="link view_larger_graph" id="cold_chain_graph">Enlarge</a> | <a class="link" href="<?php echo base_url().'cold_chain/download/0/'.$province_id.'/0';?>">Download Data</a>
</div>
...
<div class="larger_graph">
<a class="link" href="<?php echo base_url().'cold_chain/download/0/'.$province_id.'/0';?>">Download Data</a>
</div>
...
<div class="larger_graph" style="margin-top: -20px;">
	<a class="link view_larger_graph" id="mos_trend_graph">View More</a> | <a class="link" href="<?php echo base_url().'mos_trend/download_mos_trend/0/0/'.$province_id.'/0';?>">Download Data</a>
</div>
<div id = "mos_trend" title="Antigen MOS Trend"  style="margin-top: 0px;"></div>
</div>
<div class="graph" style="width: 350px; margin-left: 50px;">
<div class="larger_graph" style="margin-top: -20px;">
	<a class="link view_larger_graph" id="forecast_graph">View More</a> |<a class="link" href="<?php echo base_url().'consumption_forecast/download_forecast/0/0/0/'.$province_id.'/0';?>">Download Data</a>
</div>
<div id = "forecast" title="Antigen Consumption vs. Forecast"  style="margin-top: 0px;"></div>
</div>
<div class="graph" style="width: 350px; margin-left: 50px;">
<div class="larger_graph" style="margin-top: -20px;">
	<a class="link view_larger_graph" id="recipients_graph">View More</a> |<a class="link" href="<?php echo base_url().'antigen_recipients/download_recipients/0/0/0/'.$province_id.'/0';?>">Download Data</a>
</div>
...
<div id="mos_detailed_legend">
	...
	<div style="width:20px; height:20px; background-color: #E60000;float:left"></div>
	<div style="float:left; padding:5px;"><b>Order Now: </b> Vaccine will not last untill th next scheduled refill. Place order immediately to avoid stock out</div></div>
		<div class="legend_content">
	<div style="width:20px; height:20px; background-color: #F6BD0F;float:left"></div>
	<div style="float:left; padding:5px;"><b>Order Soon: </b> Vaccine will be below the safety level by next scheduled refill. Order soon or reschedule shipment</div></div>
	<div class="legend_content">
	<div style="width:20px; height:20px; background-color: #3DE600;float:left"></div>
	<div style="float:left; padding:5px;"><b>Sufficient: </b> Vaccine will last untill the next refill date. Monitor stock levels</div></div>
	<div class="legend_content">
...
<div id="mos_trend_filter">
	...
	<a class="link" id="trend_data_download" href="<?php echo base_url().'mos_trend/download_mos_trend/0/0/'.$province_id.'/0';?>">Download Data</a>
</div>
...
<div id="mos_detailed_legend">
	<div class="legend_content"> 
	<div style="float:left; padding:5px;"><b>*</b> Hover on points to view more info</div></div>
	<div class="legend_content">
	<div style="float:left; padding:5px;"><b>Point above the line:</b> Consumption &gt; Forecast</div></div>
	<div class="legend_content"> 
	<div style="float:left; padding:5px;"><b>Point along the line: </b> Consumption = Forecast</div></div>
	<div class="legend_content"> 
