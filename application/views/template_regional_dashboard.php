...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="wrapper">
			...
			<div id="top-panel">
				...
				<div id="logged_in">
					...
					<div id="active_dashboard">
		
			<?php
			if($dashboard_active > 0)
			{
				echo '<p style = "font: 12px;">'.$text.'</p>';
			}
			?>
		</div>
				</div>
		...
		<?php
			//This counter keeps track of how many top menus are being displayed then changes the width of the container accordingly. The default is 1 because of the default home menu
			$menu_counter = 1;
		...
		<div id="quick_menu">
		<div style="width:auto; margin-right:auto; margin-left: 120px">
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "mombasa") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/mombasa_dashboard");?>">Mombasa</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "nakuru") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/nakuru_dashboard");?>">Nakuru</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "eldoret") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/eldoret_dashboard");?>">Eldoret</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "kakamega") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/kakamega_dashboard");?>">Kakamega</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "kisumu") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/kisumu_dashboard");?>">Kisumu</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "garissa") 
			{
				echo "quick_menu_active";
			}
		?>" href="<?php echo site_url("region_view/garissa_dashboard");?>">Garissa</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "meru") 
			{
		...
		?>" href="<?php echo site_url("region_view/meru_dashboard");?>">Meru</a>
		<a  class="quick_menu_link 
		<?php
			if ($quick_link == "nyeri") 
			{
		...
		?>" href="<?php echo site_url("region_view/nyeri_dashboard");?>">Nyeri</a>
